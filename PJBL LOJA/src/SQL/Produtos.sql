...
INSERT INTO `loja`.`hardware` (`ID_Hardware`, `Nome_Har`, `marca`, `preco`, `quantidade`, `descricao`) VALUES ('4', 'Disco rigido(HD) 2TB', 'SEAGATE', '69.99', '20', 'Disco rigido de 2Terabytes para armazenamento');
...
SET `preco` = CONCAT('R$', FORMAT(`preco`, 2));

-- Alterando a coluna 'preco' para o tipo DOUBLE(10, 2)
ALTER TABLE `loja`.`perifericos`
CHANGE COLUMN `preco` `preco` DOUBLE(10, 2) NOT NULL;
